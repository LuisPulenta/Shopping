...
namespace Shopping.Controllers
{
    ...
    public class CountriesController : Controller
    {
        ...
        public async Task<IActionResult> AddState(StateViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                catch (DbUpdateException dbUpdateException)
                {
                    ...
                    {
                        _flashMessage.Danger("Ya existe un Departamento/Provincia con el mismo nombre en este país.");
                    }
                    else
                    {
            ...
            if (ModelState.IsValid)
            {
               ...
               .FirstOrDefaultAsync(c => c.Id == model.CountryId);
                ...
                catch (DbUpdateException dbUpdateException)
                {
                    if (dbUpdateException.InnerException.Message.Contains("duplicate"))
                    {
                        _flashMessage.Danger("Ya existe un Estado/Provincia con el mismo nombre en este país.");
                    }
                    else
                    {
                        _flashMessage.Danger(dbUpdateException.InnerException.Message);
            ...
            if (ModelState.IsValid)
            {
               ...
               .FirstOrDefaultAsync(c => c.Id == model.StateId);
                ...
                catch (DbUpdateException dbUpdateException)
                {
                    if (dbUpdateException.InnerException.Message.Contains("duplicate"))
                    {
                        _flashMessage.Danger("Ya existe una Ciudad con el mismo nombre en este estado/provincia.");
                    }
                    else
                    {
                        _flashMessage.Danger(dbUpdateException.InnerException.Message);
        ...
        public async Task<IActionResult> DeleteState(int? id)
        {
            ...
            {
                _flashMessage.Danger("No se puede borrar el estado / provincia porque tiene registros relacionados.");
            }
