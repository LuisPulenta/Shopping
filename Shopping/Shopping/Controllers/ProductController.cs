...
namespace Shopping.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public ProductsController(DataContext context, ICombosHelper combosHelper, IImageHelper imageHelper, IFlashMessage flashMessage)
        {
            _context = context;
        ...
        public async Task<IActionResult> AddCategory(AddCategoryProductViewModel model)
        {
            ...
            {                
                ...
                catch (DbUpdateException dbUpdateException)
                {
                    if (dbUpdateException.InnerException.Message.Contains("duplicate"))
                    {
                        _flashMessage.Danger("Ya existe esta categoría para este producto.");
                    }
                    else
                    {
                        _flashMessage.Danger(dbUpdateException.InnerException.Message);
